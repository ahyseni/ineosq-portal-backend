package com.ineos.management.config;

import com.ineos.management.entity.*;
...
@Configuration
public class IneosRestConfig implements RepositoryRestConfigurer {
   ...
   @Autowired
    public IneosRestConfig(EntityManager theEntityManager) {
